      ...
      if (status === 200 && data?.Reports?.length) {
        ...
        const formattedData = reportsArray.map((row, index) => {
          ...
          return {
            ...
            ageing0_30:
              ageingArray[index] <= 30 ? parseInt(cols[3], 10) || 0 : 0,
            ageing31_60:
              ageingArray[index] > 30 && ageingArray[index] <= 60
                ? parseInt(cols[3], 10) || 0
                : 0,
            ageing61_90:
              ageingArray[index] > 60 && ageingArray[index] <= 90
                ? parseInt(cols[3], 10) || 0
                : 0,
            ageing91_180:
              ageingArray[index] > 90 && ageingArray[index] <= 180
                ? parseInt(cols[3], 10) || 0
                : 0,
            ageingAbove180:
