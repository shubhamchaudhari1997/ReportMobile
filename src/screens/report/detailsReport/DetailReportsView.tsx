            ...
            if (status === 200 && data?.Reports?.length) {
                const formattedData = data.Reports[0].map(row => {
                    ...
                    return {
                        ...
                        ageing31_60: ageingDays > 30 && ageingDays <= 60 ? parseInt(cols[4], 10) || 0 : 0,
                        ageing61_90: ageingDays > 60 && ageingDays <= 90 ? parseInt(cols[4], 10) || 0 : 0,
                        ageing91_180: ageingDays > 90 && ageingDays <= 180 ? parseInt(cols[4], 10) || 0 : 0,
