    ...
    <View style={styles.section}>
      ...
      {data.map((item, index) => (
        ...
        >
          ...
          <Text style={[styles.cell, { flex: 1 ,left:20}]}>{item[2]}</Text>
        </View>
      ))}
    </View>
  );
        ...
        {loading ? (
          ...
          <>
            ...
            {renderTable(
              ...
              slaData.weeklyReports.reduce(
                (acc: any, _: any, i: number, arr: string | any[]) =>
            ...
            <View style={styles.section}>
              ...
              {slaData.otherActivitiesDone.map(
            ...
            <View style={styles.section}>
              ...
              <View style={[styles.row, styles.oddRow]}>
                <Text style={[styles.cell, { flex: 2 }]}>
                  {slaData.pendingWork[0]}
                </Text>
                <Text style={[styles.cell, { flex: 1.3 }]}>
                  {slaData.pendingWork[1]}
                </Text>
                <Text style={[styles.cell, { flex: 1 ,left:20}]}>
                  {slaData.pendingWork[2]}
                </Text>
              </View>
            </View>
            ...
            <View style={styles.section}>
              ...
              {slaData.actionRequiredFromClient.map(
            ...
            <View style={styles.section}>
              <Text style={styles.sectionTitle}>
                Client Feedback for the Month
              </Text>
              <Text style={styles.listItem}>
                {slaData.clientFeedback || "No feedback provided."}
              </Text>
            </View>
          </>
        ) : (
